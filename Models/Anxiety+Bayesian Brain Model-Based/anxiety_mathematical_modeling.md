...
- Amygdala (threat detection) #trust_bio/amygdala 
- Ventral vagal complex (social engagement, safety) #trust_bio/ventral_vagal_complex
...
**Heart rate variability (HRV)**, specifically high-frequency HRV (HF-HRV, 0.15-0.4 Hz), reflects parasympathetic (vagal) tone and is the gold-standard physiological index of stress regulation [2,13].  #cognitive/anxiety/state_anxiety #measures/objective_measures/HRV 
...
**Key findings:**
- High $A(t)$ → Low HRV → Reduced capacity for flexible social engagement [2] #cognitive/cognitive_reserve #measures/objective_measures/HRV #cognitive/anxiety/state_anxiety 
- HRV predicts trust in automation better than self-report measures [39] #trust #measures/objective_measures/HRV #cognitive/anxiety 
- HRV recovery time correlates with $\lambda$ (decay constant) [13] #measures/objective_measures/HRV #decay_constant #measures/objective_measures/HRV/recovery_time
