...
- **Prospect theory** [22]: Losses loom larger than gains, with a typical loss aversion coefficient of $\lambda_{\text{loss}} \approx 2-2.5$. #models/prospect_theory #decay_constant 
- **Negativity bias** [23]: Across multiple psychological domains, negative events are weighted 2-3× more heavily than positive events of equivalent objective magnitude. #perception/negativity_bias #perception/bias 
- **Neural asymmetry** [24,25]: Amygdala responses to threat-related stimuli are faster, stronger, and more persistent than responses to safety or reward signals. Loss-related activations in anterior insula exceed gain-related activations by a factor of ~2. #trust_bio/insula #trust_factors/human_factors/traits/insula_structure #trust_bio/amygdala 
...
#trust_factors/robot_factors/error 
...
- **Predictable vs. unpredictable stress** [27]: Grillon (2002) demonstrated that unpredictable shocks produce greater startle responses and sustained anxiety compared to predictable shocks of equal intensity and frequency. #perception/safety/factors/robot_factors/predictability #cognitive/anxiety/factors/predictability #trust_factors/robot_factors/predictability 
- **Controllability** [28]: Perceived controllability (a form of predictability) is one of the strongest moderators of stress responses; uncontrollable stressors produce more persistent cortisol elevation and HRV suppression. #perception/safety/factors/human_factors/sense_of_agency #trust_factors/robot_factors/predictability  #measures/objective_measures/HRV #cognitive/anxiety/bio/cortisol #perception/controllability
- **Expectancy violation** [29]: Events that violate established expectations produce larger P300 ERP components and stronger amygdala activation than expected events. #cognitive/anxiety/factors/predictability #perception/safety/factors/robot_factors/predictability #trust_factors/robot_factors/predictability 
